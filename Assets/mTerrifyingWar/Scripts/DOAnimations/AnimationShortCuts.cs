...
namespace Code.Global.Animations
{
    public static class AnimationShortCuts
    {
        ...
        public static Tween PopEffect(this Component component, in Vector3 regularScale, in float scalePercent = 1.1f, in float duration = 0.1f)
        {
        ...
        public static Tween PopEffect(this Component component, in float scalePercent = 1.1f, in float duration = 0.1f)
        {
